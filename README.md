...
<p align="center">
  <a href="mailto:dietrichvitoria29@gmail.com">📧 Email</a> •
...
- **Desenvolvimento Web:** HTML5, CSS3, JavaScript, PHP, Java, React, Kotlin, Python, SQL, MySQL, Node.js, Golang  
...
- **Suporte e Manutenção:** computadores e redes  
- Others  
...
| **Colmeia Inteligente** | Monitoramento em tempo real da saúde das abelhas | Arduino, C++, Sensores, DHT11, etc |
...
```mermaid
pie title Tecnologias Dominadas
    "Front-End (HTML, CSS, JS, Bootstrap)" : 35
    "Back-End (PHP, MySQL, Python, Golang)" : 30
    "UX/UI Design (Figma, Responsivo)" : 20
    "Gestão de Projetos & Dados" : 15
